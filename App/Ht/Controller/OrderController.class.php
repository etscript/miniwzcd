...
class OrderController extends PublicController{
	...
	*/
	public function _initialize(){
		...
		$order_status = array('0'=>'已取消','10'=>'待付款','40'=>'待评价','50'=>'交易完成');
	...
	*/
	public function show(){
		...
		$carinfo = M('user_car')->where('id='.intval($order_pro['pid']))->find();
		$carinfo['uname'] = M('user')->where('id='.intval($carinfo['uid']))->getField('name');
		$carinfo['bname'] = M('brand')->where('id='.intval($carinfo['bid']))->getField('name');
